...
router.put(
  '/user-permission-assign/:id',
  UserPermissionController.updateUserParmissionAssign
);
// router.delete('/user-permission-assign/:id', UserPermissionController.deleteUserPermissionAssign);
router.get(
  '/user-permission-assign/:user_id',
  UserPermissionController.getUserPermissionAssignByUserId
);
